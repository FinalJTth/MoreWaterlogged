...
public class ConversionMap {
    public final Map<String, Supplier<Block>> CONVERSION_MAP = new HashMap<>();
    ...
    public Block parse(String pKey, Block pBlock) {
        if (CONVERSION_MAP.containsKey(pKey)) {
            Registry.register(BuiltInRegistries.BLOCK, pKey + "_deprecated", pBlock);
            return CONVERSION_MAP.get(pKey).get();
        }
        return pBlock;
    }
